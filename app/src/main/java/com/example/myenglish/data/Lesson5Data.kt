...
object Lesson5ListeningData {
    ...
    val sentences = arrayOf(
        HomeworkSentence("Sentence 1", "Where do you eat today?", 0, 5480),
        HomeworkSentence("Sentence 2", "She wants to start the work.", 6880, 10720),
        HomeworkSentence("Sentence 3", "He doesn’t want to finish the class now.", 12170, 13060),
        HomeworkSentence("Sentence 4", "Where does she go at night?", 14360, 16980),
        HomeworkSentence("Sentence 5", "Does she like this?", 18560, 19450),
        HomeworkSentence("Sentence 6", "Cool, I have thirteen days to finish.", 20670, 22560),
        HomeworkSentence("Sentence 7", "Does it like the food?", 23930, 27390),
        HomeworkSentence("Sentence 8", "We have to study tomorrow morning.", 28880, 33740),
        HomeworkSentence("Sentence 9", "I have to eat before my class today.", 35020, 38470),
        HomeworkSentence("Sentence 10", "She wants to eat eighteen apples.", 40140, 44280),
        HomeworkSentence("Sentence 11", "They don’t have to finish twelve books.", 45500, 50000),
        HomeworkSentence("Sentence 12", "How are you today? I’m cool, thanks.", 51200, 56000),
        HomeworkSentence("Sentence 13", "What number does he want?", 57200, 62000),
        HomeworkSentence("Sentence 14", "We like to open the windows in the morning.", 63200, 68500),
        HomeworkSentence("Sentence 15", "Where does he study science?", 69700, 74800),
        HomeworkSentence("Sentence 16", "He has to work two months.", 76000, 81000),
        HomeworkSentence("Sentence 17", "Do you have to work after your class today?", 82200, 88000),
        HomeworkSentence("Sentence 18", "Sometimes I speak Spanish, but I always speak English.", 89200, 95800),
        HomeworkSentence("Sentence 19", "What things do you like to eat at home?", 97000, 102500),
        HomeworkSentence("Sentence 20", "My window doesn’t open today.", 103700, 109000),
        HomeworkSentence("Sentence 21", "Sorry, I don’t speak German.", 110200, 115000),
        HomeworkSentence("Sentence 22", "He eats hot things.", 116200, 121000),
        HomeworkSentence("Sentence 23", "What door do you wanna open now?", 122200, 127000),
        HomeworkSentence("Sentence 24", "What year do you have to go?", 128200, 133000),
        HomeworkSentence("Sentence 25", "She wants more apples and less bread.", 134200, 139500),
        HomeworkSentence("Sentence 26", "Excuse me, I have to come.", 140700, 146000),
        HomeworkSentence("Sentence 27", "Don’t worry, drink cold water and go.", 147200, 153000),
        HomeworkSentence("Sentence 28", "That’s it, you have to open thirteen doors.", 154200, 160000),
        HomeworkSentence("Sentence 29", "What days do you work this month?", 161200, 166000),
        HomeworkSentence("Sentence 30", "Where does she go at night?", 167200, 172000),
        HomeworkSentence("Sentence 31", "Please open your books and start the homework now.", 173200, 178800),
        HomeworkSentence("Sentence 32", "He starts things, but he doesn’t finish.", 180000, 186000),
        HomeworkSentence("Sentence 33", "Excuse me, do you speak French?", 187200, 193000),
        HomeworkSentence("Sentence 34", "I have to study in the morning, work in the afternoon and read at night.", 194200, 200800),
        HomeworkSentence("Sentence 35", "What month do we have to study?", 199470, 212160),
        HomeworkSentence("Sentence 36", "You help me today and I help you tomorrow, ok?", 214290, 219680),
        HomeworkSentence("Sentence 37", "I study before my class, but I eat before I study.", 221160, 226920),
        HomeworkSentence("Sentence 38", "He studies where you work.", 228500, 232640),
        HomeworkSentence("Sentence 39", "Help me, help you.", 234210, 237850)
    )
}
